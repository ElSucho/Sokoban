...
class Sokoban:
    ...
    def __init__(self):
        ...
        self.x1f = 1
        self.x1l = len(self.map) - 1
        self.y1f = 1
        self.y1l = len(self.map[0]) - 2
    ...
    def choose_map(self):
        ...
        print()
        print("Zadaj cislo mapy:")
        input_map = input()
        return maps[int(input_map) - 1].split(".")[0]
    ...
    def solve(self):
        ...
        while self.iter < self.lim:
            iter_dir = dirpath / f"{self.iter}_iteration"
            iter_dir.mkdir()
    ...
    def CNF(self):
        ...
        for x1 in range(self.x1f, self.x1l):
            for y1 in range(self.y1f, self.y1l):
                # HORE
                if (x1 - 1 >= self.x1f):
                    for i in range(1, self.iter):
                        self.actions.append([0, x1, y1, x1 - 1, y1, i])
                ...
                if (y1 - 1 >= self.y1f):
                    for i in range(1, self.iter):
                        self.actions.append([0, x1, y1, x1, y1 - 1, i])
        ...
        for x1 in range(self.x1f, self.x1l):
            for y1 in range(self.y1f, self.y1l):
                ...
                if (x1 - 2 >= self.x1f):
                    for i in range(1, self.iter):
                        self.actions.append([1, x1, y1, x1 - 1, y1, i])
                ...
                if (y1 - 2 >= self.y1f):
                    for i in range(1, self.iter):
                        self.actions.append([1, x1, y1, x1, y1 - 1, i])
        ...
        for line in self.map:
            for symbol in line:
                ...
                if (symbol == "X"):
                    ...
                    CNF_clauses.append(f"at(c,{x},{y},{self.iter - 1})")
                    CNF_clauses.append(f"-at(c,{x},{y},{self.iter - 1}) v at(C,{x},{y},{self.iter - 1})")
                if (symbol == " "):
                    CNF_clauses.append(f"-at(C,{x},{y},0)")
                if (symbol == "c"):
                    CNF_clauses.append(f"at(C,{x},{y},0)")
            ...
            for x1 in range(self.x1f, self.x1l):
                for y1 in range(self.y1f, self.y1l):
                    ...
                    for i in range(1, self.iter):
                        ...
                        CNF_clauses.append(cl)
                        cl = ""
                        if ((x1 == 1 and y1 == 1) or (x1 == 1 and y1 == self.y1l - 1) or (
                                x1 == self.x1l - 1 and y1 == 1) or (
                                    x1 == self.x1l - 1 and y1 == self.y1l - 1)) == False:
                            ...
                            for act in self.actions:
                                if (((act[3] == x1 and act[4] == y1 and act[1] == x1 - 1 and act[2] == y1) or (
                                        act[3] == x1 and act[4] == y1 and act[1] == x1 + 1 and act[2] == y1) or (
                                             ...
                                             act[3] == x1 and act[4] == y1 and act[1] == x1 and act[2] == y1 + 1)) and
                                        act[
                                            5] == i):
                                    if act[0] == 1:
                                        cl += f" v push({act[1]},{act[2]},{act[3]},{act[4]},{act[5]})"
                        ...
                        for act in self.actions:
                            if (((act[3] == x1 - 1 and act[4] == y1 and act[1] == x1 - 2 and act[2] == y1) or (
                                    act[3] == x1 + 1 and act[4] == y1 and act[1] == x1 + 2 and act[2] == y1) or (
                                         ...
                                         act[3] == x1 and act[4] == y1 + 1 and act[1] == x1 and act[2] == y1 + 2)) and
                                    act[
                                        5] == i):
                                if act[0] == 1:
                                    cl += f" v push({act[1]},{act[2]},{act[3]},{act[4]},{act[5]})"
        ...
        for x1 in range(self.x1f, self.x1l):
            for y1 in range(self.y1f, self.y1l):
                for x2 in range(self.x1f, self.x1l):
                    for y2 in range(self.y1f, self.y1l):
                        for i in range(0, self.iter):
